...
int main(int argc, char *argv[]) {
   // TODO this whole function doesn't make a lot of sense; only for computing average return, not for variance...
   // we throw away the variance info by averaging on GPU already
   // can only estimate from variance of averaged results and block_size
   // TODO so results or histogram or anything isn't correct...
  ...
  if (argc == 4) {
    ...
    fmt::print(
        "usage: visualize_returns_distribution_gpu_reduceBlock <n_gpus> <n_months> <n_simulations>, eg "
        "visualize_returns_distribution_gpu_reduceBlock 1 360 100000");
    exit(0);
  }
  ...
  // CPU computes <max_displayed_plots> for visualization, saving entire
  // trajectory
